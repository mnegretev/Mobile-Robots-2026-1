...
NAME = "Dania Melissa Belmonte González"
...
class AStarNode(Node):
    def a_star(self, start_r, start_c, goal_r, goal_c, grid_map, cost_map, use_diagonals):
        ...
        while len(open_list) > 0 and [row, col] != [goal_r, goal_c]:
            ...
            for[r,c,dist] in adjacents:
               r,c=r+row, c+col
               if r<0 or r>=height or c<0 or c>=width or grid_map[r,c] > 40 or grid_map[r,c] < 0 or in_closed_list [r,c]:
                   continue
